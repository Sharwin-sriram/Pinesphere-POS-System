...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.Order
        fields = [
            'id', 'external_id', 'restaurant_id', 'branch_id', 'customer_id', 'status', 'source',
            'delivery_type', 'delivery_address', 'scheduled_at', 'placed_at', 'total_amount', 'currency',
            'metadata', 'items', 'created_at', 'updated_at'
        ]
