...
class Order(models.Model):
    ...
    restaurant_id = models.CharField(max_length=64, null=True, blank=True)
    branch_id = models.CharField(max_length=64, null=True, blank=True)
    customer_id = models.CharField(max_length=64, null=True, blank=True)
    billing_order_id = models.CharField(max_length=64, null=True, blank=True)
    ...
    updated_by_id = models.CharField(max_length=64, null=True, blank=True)
...
class OrderItem(models.Model):
    ...
    menu_item_id = models.CharField(max_length=64, null=True, blank=True)
