...
export default function Carousel({ slides, interval = 4200 }: Props) {
 ...
 <div
 className="group relative overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/90 "
 ...
 className="pointer-events-auto flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-slate-950/60 text-white transition hover:bg-white/10"
 ...
 index === safeActive ? 'bg-violet-300 ' : 'bg-white/20 hover:bg-white/40'
 }`}
