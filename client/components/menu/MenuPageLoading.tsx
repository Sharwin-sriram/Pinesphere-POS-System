...
export default function MenuPageLoading() {
  return (
    <div className="space-y-8">
      <div className="rounded-[28px] border border-white/10 bg-slate-950/90 p-6 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.8)]">
        <Skeleton className="h-4 w-40" />
        <Skeleton className="mt-4 h-10 w-72 max-w-full" />
        <Skeleton className="mt-6 h-11 w-36" />
      </div>

      <div className="rounded-[32px] border border-white/10 bg-slate-950/90 p-5 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.8)]">
