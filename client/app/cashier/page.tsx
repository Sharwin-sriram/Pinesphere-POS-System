...
export default function CashierDashboard() {
 ...
 return (
 <div key={bill.billId} className="bg-white rounded-2xl p-6 border border-gray-100 flex flex-col">
 <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-100">
 <div className="flex items-center gap-3">
 <div className="w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-semibold text-lg shadow-inner">
 ...
 <div className="flex justify-between items-center bg-[var(--color-bg-primary)] p-4 rounded-xl mb-4">
 ...
 className="w-full flex items-center justify-center gap-2 bg-gradient-to-tr from-green-500 to-emerald-400 text-white px-6 py-3.5 rounded-xl font-semibold hover: hover:-translate-y-1 transition-all"
 >
