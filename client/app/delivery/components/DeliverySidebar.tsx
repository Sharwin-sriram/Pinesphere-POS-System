...
const menuItems = [
  ...
  { name: "Orders", href: "/delivery/active-orders", icon: Package },
  { name: "Riders", href: "/delivery/riders", icon: Bike },
  { name: "Tracking", href: "/delivery/tracking", icon: MapPinned },
  { name: "Analytics", href: "/delivery/analytics", icon: BarChart3 },
];

export default function DeliverySidebar({ isOpen = true, onClose }: DeliverySidebarProps) {
