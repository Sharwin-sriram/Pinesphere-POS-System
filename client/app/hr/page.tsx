          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{data?.total_employees}</p>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-600 mt-2">{data?.present_today}</p>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-yellow-600 mt-2">{data?.pending_leaves}</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <a href="/hr/shifts" className="w-full block px-4 py-3 bg-gray-50 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition flex items-center justify-between">
                  <span>Manage Shifts</span>
                  <span>➔</span>
                </a>
                <a href="/hr/payroll" className="w-full block px-4 py-3 bg-gray-50 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition flex items-center justify-between">
