...
export default function NotificationsPage() {
 ...
 <button className="bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-[var(--color-bg-primary)] transition text-sm">
 Mark all as read
 </button>
 </div>
 ...
 <div key={notif.id} className={`p-5 flex gap-4 transition hover:bg-[var(--color-bg-primary)] ${!notif.is_read ? 'bg-blue-50/30' : ''}`}>
 ...
 <p className={`text-sm mt-1 ${!notif.is_read ? 'text-[var(--color-text-primary)]' : 'text-gray-500'}`}>
 {notif.message}
 </p>
