...
export default function ReportsPage() {
 ...
 <div className={`p-6 bg-white rounded-xl border border-gray-100 hover: transition cursor-pointer flex gap-4 items-start`}>
 ...
 <button className="text-xs bg-[var(--color-bg-tertiary)] text-[var(--color-text-secondary)] px-3 py-1.5 rounded hover:bg-gray-200 font-medium">Export CSV</button>
 ...
 <div>
 <h1 className="text-3xl font-semibold text-gray-900">HR Reports & Analytics</h1>
 <p className="text-gray-500 mt-1">Exportable insights on staff performance, attendance, and payroll.</p>
 </div>
 <div className="flex gap-2">
 <select className="bg-white border border-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm ">
 <option>This Month</option>
 <option>Last Month</option>
 <option>This Year</option>
 </select>
 <button className="bg-gray-900 text-white px-4 py-2 rounded-lg font-medium hover:bg-black transition text-sm">
 ...
 <div className="bg-white p-6 rounded-xl border border-gray-100 lg:col-span-2">
 <h3 className="font-semibold text-[var(--color-text-primary)] mb-4">Attendance Trend (Last 7 Days)</h3>
 ...
 <div 
 className="bg-blue-500 rounded-t-sm transition-all duration-250 hover:bg-blue-600" 
 style={{ height: `${val}%` }}
 ></div>
 ...
 <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 rounded-xl text-white flex flex-col justify-center">
 <p className="text-indigo-100 font-medium text-sm">Average Staff Utilization</p>
 <h2 className="text-5xl font-semibold mt-2">92%</h2>
 ...
 <button className="mt-6 bg-white/20 hover:bg-white/30 px-4 py-2 rounded-lg text-sm font-medium transition self-start">
 View Analytics Detail
 </button>
 </div>
 </div>

 <h2 className="text-xl font-semibold text-gray-900 border-b pb-2">Available Reports</h2>
