  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Incentives & Bonuses</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mt-1">${salesBonus.toFixed(2)}</p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-gray-900 mt-1">${attendanceBonus.toFixed(2)}</p>
          </div>
          <div className="text-3xl">⏰</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-4 border-b border-gray-100 bg-gray-50">
          <input type="text" placeholder="Search employee..." className="p-2 border border-gray-200 rounded-lg text-sm shadow-sm w-64" />
        </div>
            ...
            {loading ? <tr><td colSpan={5} className="p-8 text-center text-gray-500">Loading incentives...</td></tr> : 
             ...
             incentives.map((inc: any) => (
              <tr key={inc.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap font-bold text-gray-900">${inc.amount}</td>
