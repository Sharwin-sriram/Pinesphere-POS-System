...
export default function AttendancePage() {
  ...
  const getStatusBadge = (status: string) => {
    switch(status) {
      case 'Present': return <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-green-500"></span> Present</span>;
      case 'Late': return <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-yellow-500"></span> Late</span>;
      case 'Absent': return <span className="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-red-500"></span> Absent</span>;
      case 'Leave': return <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-blue-500"></span> On Leave</span>;
      case 'Half Day': return <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-bold flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-purple-500"></span> Half Day</span>;
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3 items-center">
          <input type="date" className="p-2 border border-gray-200 rounded-lg text-sm shadow-sm" defaultValue={new Date().toISOString().split('T')[0]} />
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-green-500">
          ...
          <p className="text-2xl font-bold text-gray-900 mt-1">{metrics.present || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-red-500">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Absent Today</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">{metrics.absent || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-yellow-500">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Late Arrivals</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">{metrics.late || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-blue-500">
          ...
          <p className="text-2xl font-bold text-gray-900 mt-1">{metrics.on_leave || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 border-t-4 border-t-indigo-500">
          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Overtime Emp.</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">{metrics.overtime || 0}</p>
        </div>
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-4 rounded-xl shadow-sm text-white">
          <p className="text-xs font-semibold text-blue-100 uppercase tracking-wider">Attendance %</p>
          <p className="text-3xl font-bold mt-1">{metrics.attendance_percentage || 0}%</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Attendance Capture</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-100">
                ...
                <div className="max-w-sm">
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="text" className="w-full p-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="Enter ID..." />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">PIN</label>
                      <input type="password" className="w-full p-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" placeholder="****" />
                    </div>
                    <div className="flex gap-3 pt-2">
                      <button className="flex-1 bg-green-600 text-white py-2.5 px-4 rounded-lg font-medium hover:bg-green-700 transition shadow-sm text-sm">Check In</button>
                      <button className="flex-1 bg-red-600 text-white py-2.5 px-4 rounded-lg font-medium hover:bg-red-700 transition shadow-sm text-sm">Check Out</button>
                    </div>
                  </div>
                </div>
              )}
              ...
              {captureMethod === 'RFID' && (
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-1">RFID Reader Status: <span className="text-green-500">Connected</span></h3>
              ...
              {captureMethod === 'Biometric' && (
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-1">Biometric Device Status: <span className="text-green-500">Connected</span></h3>
              ...
              {captureMethod === 'Face Recognition' && (
                <div className="flex flex-col items-center justify-center py-2">
                  ...
                  <button className="bg-blue-600 text-white py-2.5 px-6 rounded-lg font-medium hover:bg-blue-700 transition shadow-sm flex items-center gap-2 text-sm">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            {/* Filter Bar */}
            <div className="p-4 border-b border-gray-100 flex gap-3 bg-gray-50/50 flex-wrap">
              <select className="p-2 border border-gray-200 rounded-lg text-sm bg-white shadow-sm flex-1"><option>All Branches</option></select>
              <select className="p-2 border border-gray-200 rounded-lg text-sm bg-white shadow-sm flex-1"><option>All Departments</option></select>
              <select className="p-2 border border-gray-200 rounded-lg text-sm bg-white shadow-sm flex-1"><option>All Roles</option></select>
              <select className="p-2 border border-gray-200 rounded-lg text-sm bg-white shadow-sm flex-1"><option>Status: All</option></select>
            </div>
                  ...
                  {loading ? <tr><td colSpan={7} className="p-8 text-center text-gray-500">Loading daily records...</td></tr> : 
                   ...
                   daily_records.map((rec: any) => (
                    <tr key={rec.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-700 font-bold">
                        {calculateHours(rec.check_in_time, rec.check_out_time)}
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap text-xs text-gray-500">
                        <span className="bg-gray-100 px-2 py-1 rounded border border-gray-200">{rec.method}</span>
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
             <div className="p-4 border-b border-gray-100 bg-gray-50/50">
               <h3 className="font-bold text-gray-800">Attendance Methods Usage Today</h3>
             </div>
                ...
                <ul className="space-y-3">
                  {late_arrivals.map((rec: any) => (
                    <li key={rec.id} className="flex justify-between items-center text-sm">
                      <span className="font-medium text-gray-800">{rec.employee_details?.first_name}</span>
                      <span className="text-red-600 font-bold">{rec.late_minutes} min late</span>
                    </li>
                  ))}
                </ul>
              )}
              ...
              {overtime_employees.length === 0 ? (
                ...
                <ul className="space-y-3">
                  {overtime_employees.map((rec: any) => (
                    <li key={rec.id} className="flex justify-between items-center text-sm">
                      <span className="font-medium text-gray-800">{rec.employee_details?.first_name}</span>
                      <span className="text-indigo-600 font-bold">+{rec.overtime_minutes}m</span>
                    </li>
                  ))}
                </ul>
              )}
                  ...
                  {corrections.map((corr: any) => (
                    <li key={corr.id} className="text-sm border-b pb-3 last:border-0 last:pb-0">
                      <div className="flex justify-between mb-1">
                        <span className="font-bold text-gray-800">{corr.employee_details?.first_name}</span>
                        <span className="text-xs text-gray-400">{corr.date}</span>
                      </div>
                      <p className="text-gray-600 italic text-xs">"{corr.reason}"</p>
            ...
            <div className="p-4">
              <ul className="space-y-4">
                <li className="flex justify-between items-center text-sm border-b border-gray-50 pb-3">
                  ...
                  <span className="text-green-600 font-bold flex items-center gap-1.5 text-xs"><span className="w-2 h-2 rounded-full bg-green-500"></span> Online</span>
                </li>
                <li className="flex justify-between items-center text-sm border-b border-gray-50 pb-3">
                  <span className="font-medium text-gray-800 flex items-center gap-2">
                  ...
                  <span className="text-green-600 font-bold flex items-center gap-1.5 text-xs"><span className="w-2 h-2 rounded-full bg-green-500"></span> Connected</span>
                </li>
                <li className="flex justify-between items-center text-sm border-b border-gray-50 pb-3">
                  <span className="font-medium text-gray-800 flex items-center gap-2">
                ...
                <li className="flex justify-between items-center text-sm">
                  ...
                  <span className="text-blue-600 font-bold flex items-center gap-1.5 text-xs"><span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span> Active</span>
                </li>
              </ul>
            </div>
          </div>
