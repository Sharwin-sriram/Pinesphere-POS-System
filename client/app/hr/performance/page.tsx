    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 rounded-xl shadow-md text-white">
          ...
          <p className="text-2xl font-bold mt-2">Alex Johnson</p>
          <p className="text-sm text-blue-200 mt-1">Overall Rating: 4.9/5</p>
        </div>
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6 rounded-xl shadow-md text-white">
          <p className="text-green-100 font-medium">🥇 Best Waiter</p>
          <p className="text-2xl font-bold mt-2">Sarah Smith</p>
          <p className="text-sm text-green-200 mt-1">Customer Rating: 4.8/5</p>
        </div>
        <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-6 rounded-xl shadow-md text-white">
          <p className="text-purple-100 font-medium">⏱️ Most Punctual</p>
          <p className="text-2xl font-bold mt-2">Michael Brown</p>
