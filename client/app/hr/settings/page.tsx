...
export default function SettingsPage() {
 ...
 <div>
 <h1 className="text-3xl font-semibold text-gray-900">HR Settings</h1>
 <p className="text-gray-500 mt-1">Configure automated rules, policies, and permissions.</p>
 </div>
 <button onClick={handleSave} className="bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition ">
 Save Changes
 </button>
 </div>
 ...
 activeTab === tab ? 'bg-blue-50 text-blue-700' : 'text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-primary)]'
 }`}
 >
 {tab} Settings
 </button>
 ...
 {activeTab === 'general' && (
 <div className="p-6">
 <h2 className="text-xl font-semibold text-gray-900 border-b pb-3 mb-4">General Policies</h2>
 ...
 <div className="p-6">
 <h2 className="text-xl font-semibold text-gray-900 border-b pb-3 mb-4">Attendance & Leaves</h2>
 <div className="space-y-4">
 <div className="py-4 border-b border-gray-100 flex justify-between items-center">
 <div>
 <p className="font-semibold text-[var(--color-text-primary)]">Late Arrival Threshold (Minutes)</p>
 ...
 {activeTab === 'shifts' && (
 <div className="p-6">
 <h2 className="text-xl font-semibold text-gray-900 border-b pb-3 mb-4">Shift Management</h2>
 ...
 <span className="font-semibold">Pro Tip:</span> Use the Auto-Schedule AI in the Planner to automatically balance shifts based on these rules.
 </div>
 </div>
 </div>
 )}
 ...
 {activeTab === 'payroll' && (
 <div className="p-6">
 <h2 className="text-xl font-semibold text-gray-900 border-b pb-3 mb-4">Payroll & Overtime</h2>
 <div className="space-y-4">
 <div className="py-4 border-b border-gray-100 flex justify-between items-center">
 <div>
 <p className="font-semibold text-[var(--color-text-primary)]">Overtime Pay Multiplier</p>
