          ...
          <div className="h-64 w-full flex items-end gap-2 relative">
            ...
            {[40, 60, 45, 80, 55, 90, 75, 100, 85, 110, 95, 120].map((h, i) => (
              <div key={i} className="flex-1 flex flex-col justify-end items-center group relative h-full">
                {/* Tooltip */}
                <div className="absolute -top-10 opacity-0 group-hover:opacity-100 bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded transition-opacity shadow-md">
                  ${h}k
                </div>
                {/* Bar */}
                <div 
                  className="w-full bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm opacity-80 group-hover:opacity-100 transition-all duration-300" 
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <div className="w-full mt-8 flex flex-col gap-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-gray-800 font-bold">45%</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-800 font-bold">30%</span>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-800 font-bold">25%</span>
              </div>
            </div>
          </div>
        </div>
