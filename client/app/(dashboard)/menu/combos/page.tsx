...
const comboSlides = [
  { id: 'combo-1', label: 'Meal', title: 'Combo meal slideshow', subtitle: 'Bring full meal bundles to life with immersive, animated slides.', background: '/images/menu/combos/family-feast.jpg' },
  { id: 'combo-2', label: 'Family', title: 'Family pack previews', subtitle: 'Showcase group-ready offers with premium visual cards.', background: '/images/menu/combos/family-feast.jpg' },
  { id: 'combo-3', label: 'Promo', title: 'Promotional banner stories', subtitle: 'Support upsell and limited-time offers with polished motion.', background: '/images/menu/combos/promo.jpg' },
]

const comboImageOptions = [
  { label: 'Family feast visual', value: '/images/menu/combos/family-pack.jpg' },
  { label: 'Promotional special', value: '/images/menu/combos/promo.jpg' },
  { label: 'Combo fallback', value: '/images/menu/combos/fallback.jpg' },
]
...
const initialCombos: ComboRecord[] = [
  {
    ...
    type: 'Family',
    servings: 'Serves 4',
    imageSrc: '/images/menu/combos/family-pack.jpg',
    active: true,
  },
  {
    id: 'combo-lunch',
    ...
    type: 'Lunch',
    servings: 'Serves 1',
    imageSrc: '/images/menu/combos/fallback.jpg',
    active: true,
  },
  {
    id: 'combo-dessert',
    ...
    type: 'Dessert',
    servings: 'Serves 2',
    imageSrc: '/images/menu/combos/promo.jpg',
    active: false,
  },
]
    ...
    <div className="space-y-8">
      ...
      {filteredCombos.length > 0 ? (
        ...
        <EmptyState
          ...
          previewSrc="/images/menu/combos/fallback.jpg"
            ...
            <div className="rounded-[28px] border border-white/10 bg-slate-950/80 p-4">
              ...
              <div className="mt-4 overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80">
                {previewImage ? (
                  ...
                  <img src={previewImage} alt="Combo preview" className="h-80 min-h-80 w-full object-cover" />
                ) : (
