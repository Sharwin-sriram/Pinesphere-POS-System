...
const overviewSlides = [
 { id: 'overview-1', label: 'Interiors', title: 'Restaurant interiors reimagined', subtitle: 'Showcase premium dining spaces with mood-driven imagery and intelligent menu flow.', background: '/images/menu/overview-1.svg' },
 { id: 'overview-2', label: 'Analytics', title: 'Analytics visuals built for teams', subtitle: 'Keep the menu aligned with revenue and kitchen performance in every shift.', background: '/images/menu/overview-2.svg' },
 { id: 'overview-3', label: 'Success', title: 'Onboarding success stories', subtitle: 'Promote staff adoption with polished onboarding visuals and smooth workflows.', background: '/images/menu/overview-3.svg' },
 { id: 'overview-4', label: 'Service', title: 'Food service momentum', subtitle: 'Highlight fast-paced service visuals that support a high-energy restaurant brand.', background: '/images/menu/overview-4.svg' },
]
...
export default function MenuOverviewPage() {
 ...
 <div className="space-y-5 rounded-[32px] border border-white/10 bg-slate-950/90 p-6 ">
