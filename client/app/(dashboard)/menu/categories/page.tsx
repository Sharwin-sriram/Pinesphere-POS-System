...
const categorySlides = [
  { id: 'category-1', label: 'Food', title: 'Category food image gallery', subtitle: 'Preview menus with premium category visuals designed for quick edits.', background: '/images/menu/categories/mains.jpg' },
  { id: 'category-2', label: 'Starters', title: 'Starters and sharables', subtitle: 'Highlight opening bites with rich mood-focused imagery.', background: '/images/menu/categories/starters.jpg' },
  { id: 'category-3', label: 'Drinks', title: 'Drink menu previews', subtitle: 'Show beverage selections with modern color-rich banners.', background: '/images/menu/categories/drinks.jpg' },
  { id: 'category-4', label: 'Desserts', title: 'Dessert showcase', subtitle: 'Bring sweet menu sections to life with elegant visual cues.', background: '/images/menu/categories/desserts.jpg' },
]

const categoryImageOptions = [
  { label: 'Starters visual', value: '/images/menu/categories/starters.svg' },
  { label: 'Premium mains', value: '/images/menu/categories/mains.svg' },
  { label: 'Sides collection', value: '/images/menu/categories/sides.svg' },
  { label: 'Dessert showcase', value: '/images/menu/categories/desserts.svg' },
  { label: 'Craft beverages', value: '/images/menu/categories/drinks.svg' },
  { label: 'Seasonal specials', value: '/images/menu/categories/seasonal.svg' },
]
...
const initialCategories: CategoryRecord[] = [
  {
    ...
    color: 'yellow',
    segment: 'Core',
    imageSrc: '/images/menu/categories/starters.jpg',
  ...
  },
  {
    ...
    color: 'emerald',
    segment: 'Core',
    imageSrc: '/images/menu/categories/sides.jpg',
    ...
    <div className="space-y-8">
      ...
      {filteredCategories.length > 0 ? (
        ...
        <EmptyState
          ...
          previewSrc="/images/menu/categories/fallback.jpg"
        ...
        <div className="flex flex-col gap-4">
          ...
          {filteredCategories.length > 0 ? (
            ...
            <EmptyState
              ...
              onAction={clearFilters}
              previewSrc="/images/menu/categories/seasonal.jpg"
        ...
        <form id="add-category-form" className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]" onSubmit={handleCategorySubmit}>
          ...
          <div className="space-y-5">
            <div className="rounded-[28px] border border-white/10 bg-slate-950/80 p-4">
              ...
              <div className="mt-4 overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80">
                {previewImage ? (
                  // eslint-disable-next-line @next/next/no-img-element
                  <img src={previewImage} alt="Category preview" className="h-80 min-h-80 w-full object-cover" />
                ) : (
                  <div className="flex h-80 min-h-80 items-center justify-center text-sm text-slate-500">Choose an image to preview</div>
                )}
              </div>
