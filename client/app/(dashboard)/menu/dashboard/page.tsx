...
const dashboardSlides = [
  { id: 'dashboard-1', label: 'Revenue', title: 'High-impact revenue visuals', subtitle: 'Auto-slide charts and inside data for a modern operations cockpit.', background: '/images/menu/dashboard/revenue-command.jpg' },
  { id: 'dashboard-2', label: 'Interior', title: 'Polished dining room imagery', subtitle: 'A premium lounge feel to support the restaurant brand identity.', background: '/images/menu/dashboard/lounge-flow.jpg' },
  { id: 'dashboard-3', label: 'Service', title: 'Success metrics in motion', subtitle: 'Present service wins with elegant motion and stable local artwork.', background: '/images/menu/dashboard/service-metrics.jpg' },
]
