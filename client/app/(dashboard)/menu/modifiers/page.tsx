...
const modifierSlides = [
  { id: 'modifier-1', label: 'Ingredients', title: 'Ingredient visuals slider', subtitle: 'Showcase what goes into each menu add-on with modern motion.', background: '/images/menu/modifier-1.svg' },
  { id: 'modifier-2', label: 'Sauces', title: 'Sauce and add-on previews', subtitle: 'Highlight flavor profiles and complementary extras in a visual carousel.', background: '/images/menu/modifier-2.svg' },
]
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ImageTile
          ...
          label="Ingredients"
          src="/images/menu/modifier-1.svg"
        ...
        <ImageTile
          ...
          label="Sauces"
          src="/images/menu/modifier-2.svg"
      ...
      {modifiers.length > 0 ? (
        ...
        <EmptyState
          ...
          actionLabel="Add modifier"
          onAction={() => setIsModalOpen(true)}
          previewSrc="/images/menu/fallback.svg"
