...
const itemSlides = [
  { id: 'item-1', label: 'Featured', title: 'Featured dishes carousel', subtitle: 'Make your best-selling plates pop with premium highlight slides.', background: '/images/menu/items/featured-dish.jpg' },
  { id: 'item-2', label: 'Popular', title: 'Popular menu item previews', subtitle: 'Drive attention to high-demand dishes with smooth slide motion.', background: '/images/menu/items/teriyaki-special.jpg' },
  { id: 'item-3', label: 'Highlights', title: 'Item highlight banners', subtitle: 'Pair rich visuals with quick-read item details for a premium catalog.', background: '/images/menu/items/featured-dish.jpg' },
]

const itemImageOptions = [
  { label: 'Spicy teriyaki plate', value: '/images/menu/items/teriyaki.jpg' },
  { label: 'Shrimp taco hero', value: '/images/menu/items/tacos.jpg' },
  { label: 'Smoothie spotlight', value: '/images/menu/items/smoothie.jpg' },
  { label: 'Premium fallback', value: '/images/menu/items/fallback.jpg' },
]
...
const initialItems: ItemRecord[] = [
  {
    ...
    rating: 4.8,
    spicy: 'Hot',
    imageSrc: '/images/menu/items/teriyaki.jpg',
  ...
  },
  {
    ...
    rating: 4.6,
    spicy: 'Medium',
    imageSrc: '/images/menu/items/tacos.jpg',
  ...
  },
  {
    ...
    rating: 4.2,
    spicy: 'Mild',
    imageSrc: '/images/menu/items/smoothie.jpg',
  ...
  },
  {
    ...
    rating: 4.9,
    spicy: 'Mild',
      imageSrc: '/images/menu/items/featured-dish.jpg',
    ...
    <div className="space-y-8">
      ...
      {filteredItems.length > 0 ? (
        ...
        <EmptyState
          ...
          previewSrc="/images/menu/items/fallback.jpg"
            ...
            <div className="rounded-[28px] border border-white/10 bg-slate-950/80 p-4">
              ...
              <div className="mt-4 overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80">
                {previewImage ? (
                  ...
                  <img src={previewImage} alt="Item preview" className="h-[24rem] w-full object-cover object-center sm:h-[28rem]" />
                ) : (
                  <div className="flex h-[24rem] items-center justify-center text-sm text-slate-500 sm:h-[28rem]">Choose an image to preview</div>
                )}
              </div>
