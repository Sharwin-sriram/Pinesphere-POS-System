...
export default function MenuLayout({ children }: { children: React.ReactNode }) {
 ...
 <aside className="sticky top-0 hidden h-screen w-72 flex-col border-r border-white/10 bg-slate-950/90 p-6 md:flex">
 <div className="mb-10">
 ...
 <div className="sticky top-0 z-30 border-b border-white/10 bg-slate-950/90 px-4 py-4 md:hidden">
 ...
 {menuOpen ? (
 <div className="mt-4 space-y-2 rounded-3xl border border-white/10 bg-slate-950/95 p-4 ">
 {navItems.map((item) => {
 const active = pathname === item.href
 return (
 <Link
