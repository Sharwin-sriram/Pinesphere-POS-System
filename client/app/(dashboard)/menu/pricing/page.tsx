...
const pricingSlides = [
  { id: 'pricing-1', label: 'Revenue', title: 'Revenue analytics visuals', subtitle: 'Beautifully present pricing performance with polished motion.', background: '/images/menu/pricing/premium-dining.jpg' },
  { id: 'pricing-2', label: 'Growth', title: 'Business growth banners', subtitle: 'Highlight expansion and pricing wins in a premium slideshow.', background: '/images/menu/pricing/fine-dining.jpg' },
]
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ImageTile
          ...
          label="Revenue"
          src="/images/menu/pricing/pricing-1.jpg"
        ...
        <ImageTile
          ...
          label="Growth"
          src="/images/menu/pricing/pricing-2.jpg"
      ...
      <Card>
        {pricingRules.length > 0 ? (
          ...
          <EmptyState
            ...
            onAction={() => setIsModalOpen(true)}
            previewSrc="/images/menu/pricing/pricing-1.jpg"
