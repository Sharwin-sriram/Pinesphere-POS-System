...
export default function AdminHeader({ onMenuClick }: AdminHeaderProps) {
 ...
 <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-purple-500 to-blue-500 flex items-center justify-center text-white font-semibold hover: transition-all">
 WJ
 </div>
