              ...
              {[
                ...
                return (
                  <motion.div
                    ...
                    className={`relative bg-gradient-to-br ${stat.bgColor} backdrop-blur-xl rounded-2xl p-6 border ${stat.borderColor} overflow-hidden group shadow-2xl shadow-black/20`}
                  >
