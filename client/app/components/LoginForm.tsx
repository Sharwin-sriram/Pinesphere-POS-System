...
import { FiMail, FiPhone, FiEye, FiEyeOff, FiLock, FiUser, FiChevronDown } from 'react-icons/fi';
        ...
        >
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-4xl font-bold text-slate-800 mb-2 gradient-text-light">PineSphere POS</h1>
              <p className="text-blue-600 text-lg font-medium">Restaurant Management System</p>
            </motion.div>
            ...
            >
              <h2 className="text-2xl text-slate-700 font-light">Welcome Back</h2>
        ...
        >
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              <motion.div 
                className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-2xl flex items-center justify-center mx-auto mb-4 floating"
              >
                <MdRestaurant className="text-2xl text-white" />
              </motion.div>
              <h1 className="text-2xl font-bold gradient-text-light">PineSphere POS</h1>
            </div>
            ...
            >
              ...
              <div className="mt-8 text-center">
                <p className="text-slate-500 text-sm">
                  Need help? Contact{' '}
                  <a href="mailto:support@pinesphere.com" className="text-blue-500 hover:text-blue-600">
