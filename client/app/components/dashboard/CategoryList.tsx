...
export default function CategoryList() {
 ...
 <h2 className="text-2xl font-semibold text-[var(--color-text-primary)]">What's on your mind?</h2>
 </div>
 ...
 >
 <div className="w-20 h-20 rounded-full bg-white glass-card flex items-center justify-center text-4xl group-hover: group-hover:scale-110 transition-all duration-150">
 {cat.image}
 </div>
