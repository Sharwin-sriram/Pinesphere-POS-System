...
export default function KitchenSidebar({ isOpen, onClose }: KitchenSidebarProps) {
  ...
  const menuItems = [
    { name: "Active Orders", icon: FiGrid, path: "/kitchen" },
    { name: "Account", icon: FiUser, path: "/kitchen/account" },
  ];
            ...
            return (
              <Link 
                ...
                className={`relative flex flex-col items-center justify-center w-20 py-3 rounded-2xl transition-all duration-200 group ${
                  isActive 
                    ? "bg-gradient-to-tr from-orange-500 to-red-400 text-white shadow-lg" 
